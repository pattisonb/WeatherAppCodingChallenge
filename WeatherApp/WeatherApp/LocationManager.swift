...
//found from an online source to get user's location
...
final class LocationManager: NSObject {
    ...
    typealias ReverseGeoLocationClosure = ((_ location:CLLocation?, _ placemark:CLPlacemark?,_ error: NSError?)->Void)
     var geoLocationCompletionHandler: ReverseGeoLocationClosure?
...
//MARK:- Public Methods
    ...
    //MARK:- Final closure/callback
     ...
     func didCompleteGeocoding(location:CLLocation?,placemark: CLPlacemark?,error: NSError?) {
        locationManager?.stopUpdatingLocation()
     ...
     func check(status: CLAuthorizationStatus?) {
